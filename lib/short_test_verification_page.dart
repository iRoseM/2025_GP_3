...
class _ShortTestVerificationPageState
    extends State<ShortTestVerificationPage> {
  String? selected;
  bool sending = false;
...
Widget build(BuildContext context) {
  ...
  return Directionality(
    ...
    child: Scaffold(
      ...
      body: Padding(
        padding: EdgeInsets.fromLTRB(18, topPadding - 55, 18, 18),
        child: Column(
              ...
              child: ElevatedButton(
                ...
                child: Ink(
                  decoration: BoxDecoration(
                    ...
                    color:
                        selected == null ? Colors.grey.shade300 : null,
                    borderRadius: BorderRadius.circular(14),
                  ),
                  child: Container(
