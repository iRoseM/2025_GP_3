...
class _AdminTasksPageState extends State<AdminTasksPage> {
    ...
    switch (i) {
      case 0:
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (_) => const AdminRewardsPage()));
        break;
      case 1:
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (_) => const AdminMapPage()));
        break;
      case 3:
        Navigator.pushReplacement(
          ...
          return AnimatedContainer(
            ...
            child: Column(
              children: [
                ListTile(
                  leading:
                      Icon(task['icon'], color: AppColors.primary, size: 28),
                  title: Text(
                    task['title'],
                ...
                if (isExpanded)
                  _buildExpandedTaskContent(task, index),
              ],
            ),
          );
        },
  ...
  void _showTaskDialog({required String title, Map<String, dynamic>? task}) {
    ...
    final pointsController = TextEditingController(
        text: task != null ? task['points'].toString() : '');
    String? errorMessage;
